...
-- Go To Start Button
local gotoStartBtn = Instance.new("TextButton")
gotoStartBtn.Size = UDim2.new(1, 0, 0, 30)
gotoStartBtn.Position = UDim2.new(0, 0, 0, 30)
gotoStartBtn.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
gotoStartBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
gotoStartBtn.Font = Enum.Font.SourceSansBold
gotoStartBtn.TextSize = 16
gotoStartBtn.Text = "Go to Start"
gotoStartBtn.BorderSizePixel = 1
gotoStartBtn.BorderColor3 = Color3.fromRGB(80, 80, 80)
gotoStartBtn.Parent = mainDrop

gotoStartBtn.MouseButton1Click:Connect(function()
    local char = player.Character or player.CharacterAdded:Wait()
    local hrp = char:FindFirstChild("HumanoidRootPart")
    if hrp then
        hrp.CFrame = CFrame.new(Vector3.new(-9196.98, 11.82, -25120.15))
    end
end)
